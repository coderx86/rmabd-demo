        ...
        <StaggerContainer className="space-y-6" staggerDelay={0.15}>
          {events.map((event) => (
            <motion.div key={event.id} whileHover={{ scale: 1.02, y: -5 }} transition={{ duration: 0.3 }}>
              <Card className="group hover-transition hover:shadow-lg hover:border-primary/50 bg-card border-border">
                  ...
                  <div className="hidden lg:flex lg:items-center lg:justify-between">
                    <div className="flex items-center space-x-8">
                      ...
                      <div className="flex-grow">
                        ...
                        <h3 className="text-2xl font-semibold text-foreground mb-2">{event.name}</h3>
